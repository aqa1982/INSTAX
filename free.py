...
def Subscraption():
    ...
    if key1 in r1:
        ...
        print(
            "%s\033[0;95m═════════════════════\033[0;95mꖜ\033[1;92mꖜ\033[0;97mꖜ\033[0;95m════════════════════════%s" % (
            B, P))
...
def back():
    try:
        your_name = open('.your_name.json', 'r').read()
    except:
        newbie()
...
def newbie():
    clear()
    print(logo)
    your_name = input(f'    [{H}√{P}]{K} YOUR NAME {M}? {P}: {warna} ');
    open('.your_name.json', 'w').write(your_name)
    main()
...
def newbie():
    clear()
    print(logo)
    your_name = input(f'    [{H}âˆš{P}]{K} YOUR NAME {M}? {P}: {warna} ');
    open('.your_name.json', 'w').write(your_name)
    main()
...
def random_pak_number():
    ...
    with ThreadPool(max_workers=30) as yaari:
        ...
        print('\033[1;37;1m[$] BRUTE HAS BEEN STARTED...(\033[1;92mBANGLADESH\033[1;97m)');
        print(47 * "-");
