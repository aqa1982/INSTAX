...
\033[1;91m [\033[1;94m✯\033[1;91m] \033[1;92mFB GROUP : AQA  
\033[1;91m [\033[1;94m✯\033[1;91m] \033[1;92mGITHUB   : LIBYA-1982
...
\033[1;90m══════════════════════════════════════════════════
    ...
    def api(self, uid, pwx):
        ...
        sys.stdout.write(
            "\r\r %s[OSᗩᗰᗩ] : %s/%s -> \033[0;92m [ BY-OK:%s ]- \033[0;91m[BY-CP:%s ]" % (
...
if len(sys.argv) == 2:
    if sys.argv[1] == "--info":
        ...
        print(" [*] Team      :  \n")
        print(" [ Sosial Medi  ] \n")
        print(" [*] Facebook  : https://facebook.com/OSᗩᗰᗩ-ZᗩᗰZᗩᗰ ")
        print(" [*] Instagram : https://instagram.com/LIBYA-1982")
        print(" [*] YouTube   : https://youtube.com/AQA")
        exit(" [*] GitHub    : https://github.com/kAQA1982")
    else:
        Main()
